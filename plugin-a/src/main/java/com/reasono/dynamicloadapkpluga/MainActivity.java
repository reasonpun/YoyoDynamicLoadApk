...
public class MainActivity extends DLBasePluginActivity {
    ...
    private View generateContentView(final Context context) {
        ...
        button5.setText("aar test");
        layout.addView(button5, LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
        button5.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                DLIntent intent = new DLIntent(getPackageName(), AarLibTestActivity.class);
                startPluginActivityForResult(intent, 0);
            }
        });
        return layout;
